...
export const AdminRegistrationComponent = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm, setFieldError }) => {
            ...
            const data = {
                ...
                "contactNo": Number(values.mobileNumber),
                "emailId": values.emailId,
                "username": values.username,
                "password": values.password,
                "role": "ROLE_ADMIN"
            }
            const apiUrl = "http://localhost:9090/api/admin/addAdmin";
    ...
    return (
        ...
        //             Already have account? <Link to='/admin-login' className="cursor-pointer text-teal-700 font-medium">Sign In</Link>
        //         </div>
        //     </div>
        // </form>
        ...
        <form onSubmit={formik.handleSubmit} className="d-flex justify-content-center align-items-center min-vh-100 bg-light">
            ...
            <div className="w-50 shadow-lg border border-secondary p-4 bg-white rounded-md">
                <h1 className="text-4xl mb-4 text-center">Admin Registration</h1>
                <div className="row mb-4">
                    <div className="col-md-6">
                        ...
                        {formik.errors.firstName && formik.touched.firstName && (
                            <p className="text-danger small"> {formik.errors.firstName} </p>
                        )}
                    </div>
                    <div className="col-md-6">
                        ...
                        {formik.errors.lastName && formik.touched.lastName && (
                            <p className="text-danger small"> {formik.errors.lastName} </p>
                        )}
                    </div>
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    {formik.errors.mobileNumber && formik.touched.mobileNumber && (
                        <p className="text-danger small"> {formik.errors.mobileNumber} </p>
                    )}
                </div>
                <div className="mb-4">
                ...
                <div className="mt-2 text-center">
                    Already have an account? <Link to="/admin-login" className="font-weight-bold">Sign In</Link>
                </div>
            </div>
        </form>
