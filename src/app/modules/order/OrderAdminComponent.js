...
export const OrderAdminComponent = () => {
...
export const OrderComponent = () => {
    ...
    const getAllOrders = () => {
        const apiUrl = "http://localhost:9090/api/orders/getallorders";
        axios.get(apiUrl)
        .then((response) => {
    ...
    return (
        <div>
            <div className="container mt-5" style={{ width: "100%" }}>
                {orderList.length === 0 && (
                    <div className="w-full text-2xl py-10 text-center text-gray-500">No orders found</div>
                )}
                {orderList.length > 0 && (
                            ...
                            {orderList.map((product, index) => {
                                return (
                                    <tr key={product.orderId}>
                                        ...
                                        <td className="px-20 py-4 font-weight-normal text-primary text-center">
